    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('admin.promotional-locations.update', $promotionalLocation) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="name" 
                                       name="name" 
                                       value="{{ old('name', $promotionalLocation->name) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="order" 
                                       name="order" 
                                       value="{{ old('order', $promotionalLocation->order ?? 0) }}" 
                                       min="0" 
                                       placeholder="0">
                                @error('order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" 
                                      ...
                                      name="address" 
                                      rows="2" 
                                      placeholder="Av. Santa Rosa de Lima 695, San Juan de Lurigancho 15438">{{ old('address', $promotionalLocation->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="phone" 
                                       name="phone" 
                                       value="{{ old('phone', $promotionalLocation->phone) }}" 
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="schedule" 
                                       name="schedule" 
                                       value="{{ old('schedule', $promotionalLocation->schedule) }}" 
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="url" 
                                       ...
                                       id="whatsapp_url" 
                                       name="whatsapp_url" 
                                       value="{{ old('whatsapp_url', $promotionalLocation->whatsapp_url) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3" 
                                      placeholder="Descripción de la promoción">{{ old('description', $promotionalLocation->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Nueva imagen -->
                        <div class="mb-3">
                            <label for="image" class="form-label">{{ $promotionalLocation->image ? 'Cambiar imagen' : 'Imagen de la Promoción' }}</label>
                            <input type="file" 
                        ...
                        @if($promotionalLocation->promotion_pdf)
                            <div class="mb-3">
                                <label class="form-label">PDF Promoción actual:</label>
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <span class="text-muted">{{ $promotionalLocation->promotion_pdf }}</span>
                                </div>
                            </div>
                        @endif
                        ...
                        <!-- Nuevo PDF -->
                        <div class="mb-3">
                            <label for="promotion_pdf" class="form-label">{{ $promotionalLocation->promotion_pdf ? 'Cambiar PDF Promoción' : 'PDF de Promoción' }}</label>
                            <input type="file" 
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" 
                                       ...
                                       name="active" 
                                       value="1" 
                                       {{ old('active', $promotionalLocation->active) ? 'checked' : '' }}>
