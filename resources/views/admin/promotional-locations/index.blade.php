        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">Nuestras Promociones</h3>
                    <a href="{{ route('admin.promotional-locations.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('admin.promotional-locations.show', $location) }}" 
                                                       class="btn btn-sm btn-info" title="Ver">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="{{ route('admin.promotional-locations.edit', $location) }}" 
                                                       class="btn btn-sm btn-warning" title="Editar">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('admin.promotional-locations.toggle', $location) }}" 
                                                    ...
                                                    <form action="{{ route('admin.promotional-locations.destroy', $location) }}" 
                                                          method="POST" class="d-inline"
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">Comienza agregando tu primera promoción.</p>
                            <a href="{{ route('admin.promotional-locations.create') }}" class="btn btn-primary">
                                <i class="fas fa-plus"></i> Agregar Promoción
                            </a>
                        </div>
