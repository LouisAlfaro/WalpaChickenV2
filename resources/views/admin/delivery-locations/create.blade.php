        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Agregar Nuevo Delivery</h3>
                ...
                <form action="{{ route('admin.delivery-locations.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <!-- Nombre -->
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3" 
                                      placeholder="Descripción del servicio de delivery">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Imagen -->
                        <div class="mb-3">
                            <label for="image" class="form-label">Imagen del Delivery</label>
                            <input type="file" 
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Guardar Delivery
                        </button>
                        <a href="{{ route('admin.delivery-locations.index') }}" class="btn btn-secondary">
